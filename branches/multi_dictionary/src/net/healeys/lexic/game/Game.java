...
public class Game implements Synchronizer.Counter {
	...
	// TODO: Insert Language class here
	@Deprecated
	...
	private void loadPreferences(Context c) {
		...
		// TODO: Get languages from the packages, dynamically
	...
	public void initializeDictionary() {
		// TODO: Create an alternative with the Language class
	...
	private void initializeDictionary(boolean usDict, boolean ukDict) {
		...
		try {
			// TODO: Resources now come from the Language class
	...
	public void addWord(String word) {
		...
		if(isWord(cap) && !wordsUsed.contains(cap)) {
			wordCount++;
		}
		wordsUsed.add(cap);
	}
