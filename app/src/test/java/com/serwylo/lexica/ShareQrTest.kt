...
class ShareQrTest {
    ...
    fun parseShareLink() {
        ...
        val uri = Uri.parse("https://lexica.github.io/share/?sc=12&w=7&b=QSxCLEMsRCxFLEYsRyxILEksSixLLEwsTSxOLE8sUCxRdSxSLFMsVCxVLFYsVyxYLFk&l=fr_FR&t=2700&s=l&m=4&mv=20017&v=${BuildConfig.VERSION_CODE}&h=nc")
